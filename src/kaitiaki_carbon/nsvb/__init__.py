...
# Modifications: package-name path in imports changed from
# pyfia.carbon.nsvb to kaitiaki_carbon.nsvb (relative).
...
from kaitiaki_carbon.nsvb.coefficients import (
    CoefficientTables,
...
from kaitiaki_carbon.nsvb.equations import (
    Coefficients,
    TreeBiomassResult,
