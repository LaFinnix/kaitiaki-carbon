...
def _compute_default_live_carbon_fraction() -> float:
    ...
    vendored under ``kaitiaki_carbon.nsvb.data``, and a future re-vendor could
...
def __getattr__(name: str) -> Any:
    ...
    Enables ``from kaitiaki_carbon.nsvb.carbon_fractions import DEFAULT_LIVE_CARBON_FRACTION``
